...
fds = fileDatastore('/Users/milibiswas/Desktop/UNIFR/sem2/Data Science Seminar/Dataset/20news-bydate/3NG/1/*','ReadFcn',readFcn);
bag = bagOfWords;
while hasdata(fds)
    str = read(fds);
...
readFcn = @extractFileText;
fds = fileDatastore('/Users/milibiswas/Desktop/UNIFR/sem2/Data Science Seminar/Dataset/20news-bydate/3NG/2/*','ReadFcn',readFcn);
%bag = bagOfWords;
while hasdata(fds)
    str = read(fds);
    document = tokenizedDocument(str);
...
readFcn = @extractFileText;
fds = fileDatastore('/Users/milibiswas/Desktop/UNIFR/sem2/Data Science Seminar/Dataset/20news-bydate/3NG/3/*','ReadFcn',readFcn);
%bag = bagOfWords;
while hasdata(fds)
    str = read(fds);
    document = tokenizedDocument(str);
